  ...
  window.applySimplifiedHome = function () {
    ...
    channels.forEach(function (ch, idx) {
      ...
      shtml +=
        ...
        '">' +
        '<span style="font-size:1.4rem;width:44px;height:44px;border-radius:12px;background:rgba(249,115,22,0.08);display:flex;align-items:center;justify-content:center;flex-shrink:0;">' +
        emoji +
        "</span>" +
        '<div style="flex:1;min-width:0;"><div style="font-weight:700;font-size:0.95rem;">' +
        name +
        "</div>" +
