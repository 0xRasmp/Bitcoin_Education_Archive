var CHANNELS = {
  decentralized: {
    ...
    title:
      "👪decentralized-censorship-resistant-ungovernable-incorruptible-trustless-unconfiscatable-updatable",
  ...
  dominant: {
    cat: "Properties Layer 1",
    title:
      "🏆dominant-recognizable-brand-legitimate-limitless-infinite-exponential-transformative-revolutionary",
  ...
  money: {
    cat: "Properties Layer 1",
    title:
      "💰money-deflationary-salable-durable-anti-fragile-divisible-portable-transmittable-verifiable-fair",
  ...
  organic: {
    cat: "Properties Layer 1",
    title:
      "🌳organic-empowering-elegant-freedom-centric-irrefutable-unseizable-irreversible-unbreakable",
  ...
  peaceful: {
    cat: "Properties Layer 1",
    title:
      "☮peaceful-neutral-voluntary-open-universal-permissionless-borderless-global-inevitable-unstoppable",
  ...
  programmable: {
    cat: "Properties Layer 1",
    title:
      "🤖programable-interoperable-deflationary-pseudonymous-opt-in-resilient-adiabatic-egalitarian",
  ...
  scarce: {
    cat: "Properties Layer 1",
    title:
      "🍀scarce-unforgeable-hedge-scalable-p2p-instant-open-source-auditable-inaliable",
  ...
  secure: {
    cat: "Properties Layer 1",
    title:
      "™secure-fungible-immutable-incorruptible-immalleable-infallible-reliable-predictable-irreplicable",
  ...
  supranational: {
    cat: "Properties Layer 1",
    title:
      "🕊supranational-lindy-inviolate-dilution-proof-frictionless-freely-accessible-settlement-finality",
  ...
  "evidence-against-alts": {
    cat: "Experienced Topics",
    title:
      "⚠evidence-against-ethereum-other-alt-coins-crypto-defi-nfts-web3-monero-bsv-bch-cbdcs-other-projects",
  ...
  "investment-strategy": {
    cat: "Experienced Topics",
    title:
      "🤑investment-strategy-taxes-retirement-inheritance-loans-donate-gift-consulting-remittance",
  ...
  "privacy-nonkyc": {
    cat: "Experienced Topics",
    title: "🤫privacy-nonkyc-stacking-self-sovereignty",
  ...
  "problems-of-money": {
    cat: "Experienced Topics",
    title: "📉the-problems-of-todays-money-and-freedom",
  ...
  "self-custody": {
    cat: "Experienced Topics",
    title: "🔑personal-storage-self-custody-security",
  ...
  risks__threats__attack_vectors__weaknes: {
    cat: "Additional Info",
    title: "⚔Risks, Threats, Attack Vectors, Weaknesses, Issues",
  ...
  "informational-sites": {
    cat: "Resources",
    title:
      "📃informational-sites-courses-workshops-newsletters-projects-communities-meetups-conferences",
  ...
  "jobs-earn": {
    cat: "Resources",
    title:
      "👷job-postings-employer-info-entrepreneurship-earn-bitcoin-stack-sats",
