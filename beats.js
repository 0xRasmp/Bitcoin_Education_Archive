...
window.renderBitcoinBeats = function() {
    ...
    <div id="beatsApp" style="max-width:900px;margin:20px auto;padding:0 16px;animation:fadeSlideIn 0.4s ease-out;">
        ...
        <!-- Tab Bar -->
        <style>.beats-tabbar::-webkit-scrollbar{display:none;}</style>
        <div class="beats-tabbar" style="display:flex;gap:0;border-bottom:2px solid var(--border);margin-bottom:20px;overflow-x:auto;-webkit-overflow-scrolling:touch;scrollbar-width:none;">
            <button onclick="beatsTab('discover')" id="beatsTabDiscover" class="beats-tab active" style="padding:10px 16px;background:none;border:none;border-bottom:2px solid var(--accent);margin-bottom:-2px;color:var(--accent);font-weight:700;font-size:0.82rem;cursor:pointer;font-family:inherit;white-space:nowrap;flex-shrink:0;"><i class="fa-solid fa-fire"></i> Discover</button>
