...
// === LIVE DATA AWARENESS ===
    ...
    // === BUYING & INVESTING ===
    { keys: ['how to buy','where to buy','buy bitcoin','purchase bitcoin','get bitcoin','acquire','best place to buy','good place to buy','where can i buy','where do i buy','where should i buy','my first bitcoin','first bitcoin','first purchase'],
      answer: "We have a full step-by-step guide for that, {name}! 🛒🦌 Check out <strong>Your First Bitcoin Purchase</strong> — it walks you through everything:\\n\\n1️⃣ Choose your region (11 countries/regions supported!)\\n2️⃣ Pick a trusted app (Strike, River, Cash App, Amber & more)\\n3️⃣ Buy your first sats (as little as $5!)\\n4️⃣ Move to self-custody\\n5️⃣ Set up Lightning\\n\\nReferral links are included for bonus sats! 🧡 <a href='#first-purchase' onclick='go(\"first-purchase\");return false;' style='color:var(--accent);font-weight:700;'>Open the guide →</a>",
    ...
    { keys: ['lightning address','where to get lightning address','how to get lightning address','get a lightning address','set up lightning address','ln address','receiving tips','receive sats','tip me','how do i receive tips','how to receive lightning','lnurl','lightning address provider','set up wallet','setup wallet','set up lightning','setup lightning','get a wallet','need a wallet','want a wallet','how to get wallet'],
      answer: "A Lightning Address looks like an email (you@provider.com) and lets anyone send you sats instantly! ⚡🦌 Here are the best ways to get one:\n\n⚡ **Wallet of Satoshi** — walletofsatoshi.com (easiest, mobile app)\n⚡ **Phoenix** — phoenix.acinq.co (self-custodial, you hold the keys)\n⚡ **Strike** — strike.me (bank connection, buy BTC)\n⚡ **Alby** — getalby.com (browser extension + NWC)\n⚡ **Coinos** — coinos.io (web-based, no download)\n\nOnce you have one, set it up right here in the app! I'll take you there. 🎉\n\nPro tip: Wallet of Satoshi is the fastest (2 minutes), but Phoenix gives you full key control. 🔑",
      siteAction: "go('lightning')", siteLabel: '⚡ Set Up My Lightning Wallet',
      channel: 'layer-2-lightning', channelName: 'Lightning Network' },

    { keys: ['what is webln','what is nwc','nostr wallet connect','connect wallet','how to connect lightning wallet','webln explained','how to tip','how to send tips','tipping on this site','how do tips work','connect lightning','lightning wallet','ln wallet'],
      answer: "You can connect your Lightning wallet to the Bitcoin Education Archive in two ways, {name}! ⚡🦌\n\n**WebLN** — If you use the Alby browser extension (getalby.com), click Connect on the Lightning page. One click!\n\n**NWC (Nostr Wallet Connect)** — Works on mobile! Copy your NWC string from your wallet app and paste it in.\n\n**Or just add a Lightning Address** — the easiest option! Get one from Wallet of Satoshi, Phoenix, or Strike, then save it on the Lightning page.\n\nOnce set up, you can tip other users on forum posts, Beats tracks, marketplace listings, leaderboard, and IRL events. Just hit the ⚡ button! 🔐",
      siteAction: "go('lightning')", siteLabel: '⚡ Go to Lightning Wallet Setup',
      channel: 'layer-2-lightning', channelName: 'Lightning Network' },
    ...
    { keys: ['irl','meetup','event','gathering','local','irl sync','bitcoin meetup','local event','find meetup','find event'],
      answer: "IRL Sync helps you find and create local Bitcoin meetups and events! See what's happening near you, RSVP, and connect with Bitcoiners in real life. 🤝 Plus check out <strong>Meetup-in-a-Box</strong> — 5 ready-made templates with timed agendas you can download and use!",
      channel: null, channelName: null },
    { keys: ['meetup in a box','meetup box','meetup template','agenda template','host a meetup','run a meetup','organize a meetup','meetup agenda','lightning workshop','self custody workshop'],
      answer: "Meetup-in-a-Box has 5 ready-made templates, {name}! 📦🦌\\n\\n📘 Your First Meetup (1 hr, beginner)\\n⚡ Lightning Workshop (1.5 hr)\\n🔐 Self-Custody Workshop (1.5 hr)\\n🌍 Bitcoin vs. The System (1.5 hr)\\n⛏️ Mining & Energy Deep Dive (1.5 hr)\\n\\nEach has a timed agenda, host tips, and links to archive channels for prep. You can download them as text files too!",
      siteAction: "go('irl-sync')", siteLabel: '📦 Open Meetup-in-a-Box', isSiteNav: true },
    { keys: ['bitcoin buddy','find a buddy','learning partner','mentor','find a mentor','find a teacher','teach','learn together','study partner','study buddy'],
      answer: "Bitcoin Buddy pairs teachers with learners! 🤝🦌 Go to Global Chat and tap 'Find a Buddy'. Pick whether you want to Learn or Teach, add your experience level, and we'll match you with someone complementary. When matched, you'll get a DM conversation started with one of my icebreakers! 🧡",
      siteAction: "if(typeof renderChatHub==='function')renderChatHub('global')", siteLabel: '🤝 Find a Buddy', isSiteNav: true },
    { keys: ['shareable certificate','share certificate','verification link','verify certificate','cert link','public certificate','share my cert','certificate url'],
      answer: "When you pass the Scholar Certification, you get a verifiable public URL you can share on social media! 🎓🦌 It proves your Bitcoin knowledge with a unique verification link anyone can check. Take the exam in Settings → Scholar Certification!",
      siteAction: "showSettings();setTimeout(function(){showSettingsPage('scholar')},100)", siteLabel: '🎓 Take the Exam', isSiteNav: true },
    { keys: ['sats vs bits','sats or bits','denomination','should i say sats','should i say bits','unit of bitcoin','satoshi vs bit'],
      answer: "The great debate! 🦌⚡ Should we call the smallest common unit 'sats' (satoshis) or 'bits' (100 satoshis)? Cast your vote in the live Sats vs Bits poll in Global Chat! Tap-vote in real time and see the community consensus.",
...
// === FOLLOW-UP COVERAGE — entries to match follow-up suggestions ===
{ keys: ['can i mine at home','home mining','mine at home','bitcoin mining at home','mine bitcoin at home','bitaxe'],
  answer: "Yes you can mine at home, {name}! ⛏️🦌 You won't be profitable competing with industrial farms, but home mining is about SOVEREIGNTY — you're directly supporting the network. Options: 1️⃣ **Bitaxe** — open-source USB miner (~500 GH/s, $50-100, earns ~1-5 sats/day). 2️⃣ **Antminer S9** — older model, cheap, but loud and power-hungry. 3️⃣ **Heating miners** — companies like Heatbit turn mining heat into home heating! The point isn't profit — it's participating in the most secure network ever built. 🔥",
  channel: 'mining', channelName: 'Mining' },
{ keys: ['what is an asic','asic','asic miner','application specific','mining hardware','antminer'],
  answer: "An ASIC (Application-Specific Integrated Circuit) is a computer chip designed to do ONE thing: mine Bitcoin! ⛏️🦌 Unlike regular CPUs or GPUs, ASICs are purpose-built for SHA-256 hashing. They're thousands of times more efficient than general hardware. Major manufacturers: Bitmain (Antminer), MicroBT (WhatsMiner), and Canaan. The latest models do 100+ TH/s! Fun fact: the open-source Bitaxe is a tiny ASIC you can run at home. 🔧",
  channel: 'mining', channelName: 'Mining' },
{ keys: ['how secure is bitcoin','bitcoin security','is bitcoin safe','how safe is bitcoin','can bitcoin be hacked','bitcoin hack'],
  answer: "Bitcoin is the most secure computing network in human history, {name}! 🛡️🦌 It has more computing power protecting it than all supercomputers combined. To attack it, you'd need 51% of global hashrate (costing billions), and even then you could only double-spend YOUR OWN coins — not steal anyone else's. No one has ever hacked the Bitcoin protocol in 15+ years. Individual exchanges and wallets can be compromised, but that's user security, not Bitcoin security. Your private keys + hardware wallet = virtually unhackable. 🔐",
  channel: 'secure', channelName: 'Secure' },
{ keys: ['how much should i invest','how much to invest','how much bitcoin should i buy','how much to buy','minimum investment'],
  answer: "The golden rule: never invest more than you can afford to lose, {name}! 🦌💰 There's no minimum — you can buy $1 worth of Bitcoin (that's about 1,000 sats at current prices). Many Bitcoiners recommend: 1️⃣ Start with an amount you're comfortable losing entirely. 2️⃣ DCA (Dollar Cost Average) weekly or monthly. 3️⃣ Increase allocation as your understanding grows. Michael Saylor says 'buy Bitcoin and never sell,' but you should do your own research first. This is NOT financial advice! ⚠️",
  channel: 'investment-strategy', channelName: 'Investment Strategy' },
{ keys: ['is now a good time to buy','good time to buy','should i buy now','when to buy','best time to buy bitcoin','timing the market'],
  answer: "The best time to buy Bitcoin was yesterday. The second best time is today! 🦌📈 Historically, EVERY 4-year period has been profitable for Bitcoin holders. Instead of timing the market, Bitcoiners use DCA — buying a fixed amount regularly regardless of price. This removes emotion and averages out volatility. Remember: no one who held for 4+ years has EVER lost money. But this is NOT financial advice — do your own research! ⚠️",
  channel: 'investment-strategy', channelName: 'Investment Strategy' },
{ keys: ['what is hodl','hodl','hodl meaning','why hodl','hodling'],
  answer: "HODL originated from a legendary 2013 BitcoinTalk forum post by user GameKyuubi, {name}! 🍺🦌 During a price crash, GameKyuubi wrote a funny and inspirational post titled 'I AM HODLING' — a misspelling of 'holding' that became Bitcoin's most famous meme. The community loved it so much that HODL stuck and later became the backronym 'Hold On for Dear Life.' HODLing means buying Bitcoin and holding it long-term through all the volatility — crashes, FUD, and all. The philosophy: Bitcoin's long-term trend is up, so selling during dips means missing the recovery. Diamond hands! 💎🙌",
  channel: 'investment-strategy', channelName: 'Investment Strategy' },
...
function matchSiteNavigation(input) {
    ...
    var SITE_NAV = [
        ...
        { patterns: /where.*(lightning|wallet|tip|connect.*wallet|send.*sats)|how.*(tip|send.*sats|connect.*lightning|connect.*wallet|set.*up.*wallet|get.*wallet|receive.*tip)|lightning.*wallet|wallet.*connect|tip.*someone|send.*tip|set.*up.*wallet|setup.*wallet|get.*a.*wallet|need.*wallet|want.*wallet|receive.*tips/,
          answer: "Head to ⚡ Lightning Wallet to get set up! You can add a Lightning Address (easiest — takes 2 minutes with Wallet of Satoshi or Phoenix), or connect via WebLN/NWC for full send+receive. Once set up, tip users across the whole app! 🦌",
          action: "go('lightning')", label: "⚡ Set Up Lightning Wallet" },
